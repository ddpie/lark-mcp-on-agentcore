...
./scripts/test.sh --full           # 全部含 audit + e2e (需 AWS)
...
./scripts/test.sh --full           # All tiers including audit + e2e (needs AWS)
...
npm test                           # Run vitest unit tests (220 cases)
```
