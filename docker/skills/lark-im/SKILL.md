...
| `lark_get_skill(domain="im", section="chat-list")` | List groups the current user/bot is a member of; user/bot; supports sorting, pagination, and exclude_muted (user identity only) |
