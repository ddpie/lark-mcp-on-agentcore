...
```
lark_base_base_create(name="New Base")

lark_base_base_create(name="项目管理", folder_token="fld_xxx", time_zone="Asia/Shanghai")
```
...
- `lark_get_skill(domain="base", section="base-copy")` — 复制 Base
