...
- `lark_get_skill(domain="base", section="workflow-create")` — 创建工作流命令
- `lark_get_skill(domain="base", section="workflow-update")` — 更新工作流命令
- `lark_get_skill(domain="base", section="workflow-list")` — 列出工作流命令
