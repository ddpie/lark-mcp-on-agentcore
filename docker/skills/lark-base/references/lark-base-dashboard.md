...
| 读取图表最终计算结果 | `+dashboard-block-get-data` | `lark_get_skill(domain="base", section="dashboard-block-get-data")` |
...
| `+dashboard-block-get-data` | 获取图表组件计算结果 | `lark_get_skill(domain="base", section="dashboard-block-get-data")` |
