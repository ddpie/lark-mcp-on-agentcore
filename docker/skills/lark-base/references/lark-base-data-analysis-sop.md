...
- `+data-query`: `lark_get_skill(domain="base", section="data-query")`
- 视图筛选/排序/投影: `lark_get_skill(domain="base", section="view-set-filter")`, `lark_get_skill(domain="base", section="view-set-sort")`, `lark_get_skill(domain="base", section="view-set-visible-fields")`
- 记录读取: `lark_get_skill(domain="base", section="record")`
...
- 字段类型、日期 value、DSL shape 以 `lark_get_skill(domain="base", section="data-query")` 为准。
