...
- 确定需要插入哪些图表后，参照 `lark_get_skill(domain="doc", section="whiteboard")` 中的方式，插入图表画板。
...
|-|-|-|-|
| 信息、说明 | info "说明：" | `light-blue` | `blue` |
| 成功、推荐 | checkmark "推荐：" | `light-green` | `green` |
| 警告 / 错误 / 风险 | warning crossmark | `light-red` | `red` |
| 注意、待确认 | exclamation "注意：" | `light-yellow` | `yellow` |
| 中性、辅助 | — | `light-gray` | — |
